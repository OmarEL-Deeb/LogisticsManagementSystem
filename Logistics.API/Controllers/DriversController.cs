...
namespace Logistics.API.Controllers
{
    ...
    public class DriversController : ControllerBase
    {
        ...
        [HttpPost] public async Task<IActionResult> Create([FromBody] RequireDriverDto dto) { var res = await _service.CreateAsync(dto); return CreatedAtAction(nameof(GetById), new { id = res.DriverId }, res); }
        [HttpPut("{id}")] public async Task<IActionResult> Update(int id, [FromBody] RequireDriverDto dto) { await _service.UpdateAsync(id, dto); return NoContent(); }
